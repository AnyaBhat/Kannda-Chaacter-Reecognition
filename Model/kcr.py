...
# Provide the path of the Kannada document image for prediction
document_path = 'D:\Final_year_project\dataset\Img\img072-007.png' # Update with your image path

# Read and preprocess the image
input_image = load_and_preprocess_image(document_path, img_size=(64, 64))

# Reshape the image for prediction
input_image_reshaped = input_image.reshape(-1, 64, 64, 1)
...
# Print the predicted class and corresponding Kannada character
print(f"Predicted Class: {predicted_class}, Predicted Character: {predicted_char}")
